...
import heroPinIowa from '@/app/(site)/assets/iowa/hero-pin-iowa.png'
import overviewVehicleInspectionTechnology from '@/app/(site)/assets/iowa/overview-vehicle-inspection-technology.png'
import regionCedarRapids from '@/app/(site)/assets/iowa/region-cedar-rapids.png'
import regionDesMoines from '@/app/(site)/assets/iowa/region-des-moines.png'
