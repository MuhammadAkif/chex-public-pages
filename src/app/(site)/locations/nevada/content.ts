...
export const nevadaContent = {
  ...
  overview: {
    ...
    image: "https://chex-payload-public-pages.s3.us-east-1.amazonaws.com/overview-carriers.png",
    ...
    items: [
      {
        ...
        image: "https://chex-payload-public-pages.s3.us-east-1.amazonaws.com/region-las-vegas.png",
      },
      {
        city: 'Reno',
        description: 'Chex AI helps you track corrosion and salt damage.',
        image: "https://chex-payload-public-pages.s3.us-east-1.amazonaws.com/region-reno.png",
      },
    ],
  },
  manage: {
