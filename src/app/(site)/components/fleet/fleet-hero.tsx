...
export function FleetHero({
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-[1240px] items-center gap-10 px-4 pb-16 pt-12 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 lg:px-10 lg:pb-24 lg:pt-20">
        <div>
