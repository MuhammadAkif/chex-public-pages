...
export function SouthCarolinaCta({
  title,
  description,
  primaryLabel,
  secondaryLabel,
  helperText,
  image,
}: SouthCarolinaCtaProps) {
  return (
    <section id="south-carolina-demo" className="bg-white px-4 pb-20 sm:px-6 lg:px-10 lg:pb-28">
