...
## Summary
- 148 nodes · 216 edges · 24 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.62)
...
1. `src/app/(site)/components/locations/location-page.tsx` - 24 edges
2. `src/app/(site)/locations/payload.ts` - 19 edges
3. `getLocationPageBySlug()` - 14 edges
4. `generateMetadata()` - 13 edges
5. `src/app/(site)/components/home/home-page.tsx` - 13 edges
6. `LocationPage()` - 12 edges
7. `src/app/(site)/components/shared/site-image.tsx` - 11 edges
...
Cohesion: 0.12
Nodes (22): HomeBenefits(), HomeBusinessHelp(), HomeCallToAction(), HomeHero(), HomeHowItWorks(), HomeKeyDifferentiators(), src/app/(site)/components/home/home-benefits.tsx, src/app/(site)/components/home/home-business-help.tsx (+14 more)
...
Cohesion: 0.25
Nodes (5): Reveal(), useReveal(), src/app/(site)/components/locations/location-case-studies.tsx, src/app/(site)/components/shared/case-studies.tsx, src/app/(site)/components/shared/reveal.tsx

### Community 4 - "Community 4"
Cohesion: 0.22
Nodes (5): src/app/(site)/components/locations/location-cta.tsx, src/app/(site)/components/locations/location-hero.tsx, src/app/(site)/components/locations/location-manage.tsx, src/app/(site)/components/locations/location-services.tsx, src/app/(site)/components/ui/button.tsx

### Community 5 - "Community 5"
Cohesion: 0.28
Nodes (9): LocationPage(), AlabamaRoutePage(), OhioRoutePage(), src/app/(site)/components/locations/location-page.tsx, src/app/(site)/components/locations/location-regions.tsx, src/app/(site)/locations/alabama/page.tsx, dynamic, src/app/(site)/locations/ohio/page.tsx (+1 more)
...
Cohesion: 0.29
Nodes (6): generateMetadata(), IowaRoutePage(), src/app/(payload)/admin/[[...segments]]/page.tsx, generateMetadata, src/app/(site)/locations/iowa/page.tsx, dynamic
...
Cohesion: 0.2
Nodes (3): src/app/(site)/components/locations/location-faq.tsx, src/app/(site)/components/locations/location-overview.tsx, src/app/(site)/components/locations/location-showcase.tsx

### Community 11 - "Community 11"
Cohesion: 0.5
Nodes (4): NewMexicoRoutePage(), getLocationPageBySlug(), src/app/(site)/locations/new-mexico/page.tsx, dynamic
...
Cohesion: 0.67
Nodes (3): ArizonaRoutePage(), src/app/(site)/locations/arizona/page.tsx, dynamic
...
Cohesion: 0.67
Nodes (3): ColoradoRoutePage(), src/app/(site)/locations/colorado/page.tsx, dynamic
...
- **Thin community `Community 20`** (2 nodes): `SitePage()`, `src/app/(site)/page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (2 nodes): `RootLayout()`, `src/app/layout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `src/types/env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `src/types/payload-import-map.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `src/app/(site)/components/locations/location-page.tsx` connect `Community 5` to `Community 0`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`?**
  _High betweenness centrality (0.332) - this node is a cross-community bridge._
- **Why does `src/app/(site)/components/shared/site-image.tsx` connect `Community 0` to `Community 2`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `src/app/(site)/components/shared/reveal.tsx` connect `Community 3` to `Community 0`, `Community 5`?**
